...
public final class ActiveProgressCircle extends View {
    ...
    /* JADX INFO: compiled from: ActiveProgressCircle.kt */
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0086T¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lcom/dwiot/dwstep/view/ActiveProgressCircle$Companion;", "", "()V", "ARC_WIDTH_SCALE", "", "CIRCLE_SPACE_SCALE", "SHADOW_DEGREE_OFFSET", "", "START_ANGLE", "", "TAG", "", "Step_release"}, k = 1, mv = {1, CharacterSets.ISO_8859_6, 0}, xi = 48)
    ...
    public final void startAnimateProgress() {
        if (this.animate) {
            ...
            this.animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.dwiot.dwstep.view.ActiveProgressCircle$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ActiveProgressCircle.startAnimateProgress$lambda$1(this.f$0, f, f2, f3, valueAnimator);
                }
            });
            this.animator.addListener(new Animator.AnimatorListener() { // from class: com.dwiot.dwstep.view.ActiveProgressCircle.startAnimateProgress.2
    ...
    public final void increaseWithAnim(final float outDegree, final float midDegree, final float innerDegree) {
        if (this.animate) {
            ...
            this.animator.setDuration(this.animateDuration);
            this.animator.setInterpolator(new AccelerateDecelerateInterpolator());
            this.animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.dwiot.dwstep.view.ActiveProgressCircle$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ActiveProgressCircle.increaseWithAnim$lambda$3(this.f$0, f, outDegree, f2, midDegree, f3, innerDegree, valueAnimator);
                }
            });
            this.animator.addListener(new Animator.AnimatorListener() { // from class: com.dwiot.dwstep.view.ActiveProgressCircle.increaseWithAnim.2
                @Override // android.animation.Animator.AnimatorListener
                public void onAnimationCancel(Animator animation) {
                    Intrinsics.checkNotNullParameter(animation, "animation");
                }
