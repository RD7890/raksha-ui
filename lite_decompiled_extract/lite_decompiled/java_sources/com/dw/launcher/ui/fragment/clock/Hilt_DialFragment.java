...
public abstract class Hilt_DialFragment extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((DialFragment_GeneratedInjector) generatedComponent()).injectDialFragment((DialFragment) UnsafeCasts.unsafeCast(this));
    }
