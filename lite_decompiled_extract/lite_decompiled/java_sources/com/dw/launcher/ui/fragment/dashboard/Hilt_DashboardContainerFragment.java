...
public abstract class Hilt_DashboardContainerFragment extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((DashboardContainerFragment_GeneratedInjector) generatedComponent()).injectDashboardContainerFragment((DashboardContainerFragment) UnsafeCasts.unsafeCast(this));
    }
