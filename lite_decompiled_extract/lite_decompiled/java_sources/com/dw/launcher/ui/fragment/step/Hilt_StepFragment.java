...
public abstract class Hilt_StepFragment<VM extends AndroidViewModel, VDB extends ViewDataBinding> extends VMBaseFragment<VM, VDB> implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((StepFragment_GeneratedInjector) generatedComponent()).injectStepFragment((StepFragment) UnsafeCasts.unsafeCast(this));
    }
