...
public class ItemStepDataView extends RelativeLayout {
    ...
    public ItemStepDataView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mRootView = View.inflate(context, R.layout.item_step_data, this);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, R.styleable.itemStepData);
