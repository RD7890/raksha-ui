...
public final class HalfCyclicDashboard_MembersInjector implements MembersInjector<HalfCyclicDashboard> {
    ...
    public HalfCyclicDashboard_MembersInjector(Provider<SensorComponent> mSensorComponentProvider, Provider<SoundEffect> soundEffectProvider, Provider<WallpaperComponent> wallpaperComponentProvider, Provider<LauncherPreference> mPreferenceProvider, Provider<NoDisturbComponent> noDisturbComponentProvider, Provider<SysKeyEvent> sysKeyEventProvider, Provider<LauncherRepository> launcherRepositoryProvider) {
    ...
    public static MembersInjector<HalfCyclicDashboard> create(Provider<SensorComponent> mSensorComponentProvider, Provider<SoundEffect> soundEffectProvider, Provider<WallpaperComponent> wallpaperComponentProvider, Provider<LauncherPreference> mPreferenceProvider, Provider<NoDisturbComponent> noDisturbComponentProvider, Provider<SysKeyEvent> sysKeyEventProvider, Provider<LauncherRepository> launcherRepositoryProvider) {
        return new HalfCyclicDashboard_MembersInjector(mSensorComponentProvider, soundEffectProvider, wallpaperComponentProvider, mPreferenceProvider, noDisturbComponentProvider, sysKeyEventProvider, launcherRepositoryProvider);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(HalfCyclicDashboard instance) {
    ...
    public static void injectSysKeyEvent(HalfCyclicDashboard instance, SysKeyEvent sysKeyEvent) {
        instance.sysKeyEvent = sysKeyEvent;
    }

    public static void injectLauncherRepository(HalfCyclicDashboard instance, LauncherRepository launcherRepository) {
