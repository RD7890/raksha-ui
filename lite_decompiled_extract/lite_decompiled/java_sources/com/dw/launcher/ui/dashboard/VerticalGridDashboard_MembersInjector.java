...
public final class VerticalGridDashboard_MembersInjector implements MembersInjector<VerticalGridDashboard> {
    ...
    public static MembersInjector<VerticalGridDashboard> create(Provider<SensorComponent> mSensorComponentProvider, Provider<SoundEffect> soundEffectProvider, Provider<WallpaperComponent> wallpaperComponentProvider, Provider<LauncherPreference> mPreferenceProvider, Provider<NoDisturbComponent> noDisturbComponentProvider, Provider<LauncherRepository> launcherRepositoryProvider, Provider<SysKeyEvent> sysKeyEventProvider) {
        return new VerticalGridDashboard_MembersInjector(mSensorComponentProvider, soundEffectProvider, wallpaperComponentProvider, mPreferenceProvider, noDisturbComponentProvider, launcherRepositoryProvider, sysKeyEventProvider);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(VerticalGridDashboard instance) {
    ...
    public static void injectLauncherRepository(VerticalGridDashboard instance, LauncherRepository launcherRepository) {
        instance.launcherRepository = launcherRepository;
    }

    public static void injectSysKeyEvent(VerticalGridDashboard instance, SysKeyEvent sysKeyEvent) {
