...
public abstract class Hilt_VerticalGridDashboard extends BaseDashboard {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((VerticalGridDashboard_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectVerticalGridDashboard((VerticalGridDashboard) UnsafeCasts.unsafeCast(this));
    }
}
