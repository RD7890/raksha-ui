...
public final class HoneycombDashboard_MembersInjector implements MembersInjector<HoneycombDashboard> {
    ...
    public static MembersInjector<HoneycombDashboard> create(Provider<SensorComponent> mSensorComponentProvider, Provider<SoundEffect> soundEffectProvider, Provider<WallpaperComponent> wallpaperComponentProvider, Provider<LauncherPreference> mPreferenceProvider, Provider<NoDisturbComponent> noDisturbComponentProvider, Provider<SysKeyEvent> sysKeyEventProvider, Provider<LauncherRepository> launcherRepositoryProvider) {
        return new HoneycombDashboard_MembersInjector(mSensorComponentProvider, soundEffectProvider, wallpaperComponentProvider, mPreferenceProvider, noDisturbComponentProvider, sysKeyEventProvider, launcherRepositoryProvider);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(HoneycombDashboard instance) {
    ...
    public static void injectSysKeyEvent(HoneycombDashboard instance, SysKeyEvent sysKeyEvent) {
        instance.sysKeyEvent = sysKeyEvent;
    }

    public static void injectLauncherRepository(HoneycombDashboard instance, LauncherRepository launcherRepository) {
