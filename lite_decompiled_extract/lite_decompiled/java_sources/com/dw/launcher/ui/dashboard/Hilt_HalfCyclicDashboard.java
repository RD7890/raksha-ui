...
public abstract class Hilt_HalfCyclicDashboard extends BaseDashboard {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((HalfCyclicDashboard_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectHalfCyclicDashboard((HalfCyclicDashboard) UnsafeCasts.unsafeCast(this));
    }
}
