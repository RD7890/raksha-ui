...
public abstract class Hilt_GridDashboard extends BaseDashboard {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((GridDashboard_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectGridDashboard((GridDashboard) UnsafeCasts.unsafeCast(this));
    }
}
