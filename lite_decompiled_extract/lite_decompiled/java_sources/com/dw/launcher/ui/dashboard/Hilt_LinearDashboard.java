...
public abstract class Hilt_LinearDashboard extends BaseDashboard {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((LinearDashboard_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectLinearDashboard((LinearDashboard) UnsafeCasts.unsafeCast(this));
    }
}
