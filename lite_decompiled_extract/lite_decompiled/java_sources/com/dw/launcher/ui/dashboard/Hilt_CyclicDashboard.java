...
public abstract class Hilt_CyclicDashboard extends BaseDashboard {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((CyclicDashboard_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectCyclicDashboard((CyclicDashboard) UnsafeCasts.unsafeCast(this));
    }
}
