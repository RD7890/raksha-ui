...
public abstract class Hilt_BaseDashboard extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((BaseDashboard_GeneratedInjector) generatedComponent()).injectBaseDashboard((BaseDashboard) UnsafeCasts.unsafeCast(this));
    }
