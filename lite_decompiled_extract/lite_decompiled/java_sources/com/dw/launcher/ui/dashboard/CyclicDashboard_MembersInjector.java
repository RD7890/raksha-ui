...
public final class CyclicDashboard_MembersInjector implements MembersInjector<CyclicDashboard> {
    ...
    public static MembersInjector<CyclicDashboard> create(Provider<SensorComponent> mSensorComponentProvider, Provider<SoundEffect> soundEffectProvider, Provider<WallpaperComponent> wallpaperComponentProvider, Provider<LauncherPreference> mPreferenceProvider, Provider<NoDisturbComponent> noDisturbComponentProvider, Provider<SysKeyEvent> sysKeyEventProvider) {
        return new CyclicDashboard_MembersInjector(mSensorComponentProvider, soundEffectProvider, wallpaperComponentProvider, mPreferenceProvider, noDisturbComponentProvider, sysKeyEventProvider);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(CyclicDashboard instance) {
    ...
    public static void injectSysKeyEvent(CyclicDashboard instance, SysKeyEvent sysKeyEvent) {
