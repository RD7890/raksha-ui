...
public final class GridDashboard_MembersInjector implements MembersInjector<GridDashboard> {
    ...
    public static MembersInjector<GridDashboard> create(Provider<SensorComponent> mSensorComponentProvider, Provider<SoundEffect> soundEffectProvider, Provider<WallpaperComponent> wallpaperComponentProvider, Provider<LauncherPreference> mPreferenceProvider, Provider<NoDisturbComponent> noDisturbComponentProvider, Provider<SysKeyEvent> sysKeyEventProvider) {
        return new GridDashboard_MembersInjector(mSensorComponentProvider, soundEffectProvider, wallpaperComponentProvider, mPreferenceProvider, noDisturbComponentProvider, sysKeyEventProvider);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(GridDashboard instance) {
    ...
    public static void injectSysKeyEvent(GridDashboard instance, SysKeyEvent sysKeyEvent) {
