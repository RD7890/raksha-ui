...
public final class HalfCyclicSnapHelper extends SnapHelper {
    ...
    public int[] calculateDistanceToFinalSnap(RecyclerView.LayoutManager layoutManager, View targetView) {
        ...
        int[] iArr = new int[2];
        if (layoutManager instanceof HalfCyclicLayoutManager2) {
            int snapLeftViewDistance = ((HalfCyclicLayoutManager2) layoutManager).getSnapLeftViewDistance();
    ...
    public View findSnapView(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager instanceof HalfCyclicLayoutManager2) {
            return ((HalfCyclicLayoutManager2) layoutManager).findSnapView();
        }
        return null;
    }
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        if (layoutManager instanceof HalfCyclicLayoutManager2) {
            HalfCyclicLayoutManager2 halfCyclicLayoutManager2 = (HalfCyclicLayoutManager2) layoutManager;
            if (halfCyclicLayoutManager2.getChildCount() > 0 && halfCyclicLayoutManager2.canScrollVertically()) {
                return halfCyclicLayoutManager2.findTargetSnapPosition(velocityY);
            }
        }
        return -1;
    }
