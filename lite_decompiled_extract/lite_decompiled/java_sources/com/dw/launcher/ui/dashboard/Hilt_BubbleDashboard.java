...
public abstract class Hilt_BubbleDashboard extends BaseDashboard {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((BubbleDashboard_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectBubbleDashboard((BubbleDashboard) UnsafeCasts.unsafeCast(this));
    }
}
