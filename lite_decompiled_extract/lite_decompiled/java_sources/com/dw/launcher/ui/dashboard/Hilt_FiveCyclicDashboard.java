...
public abstract class Hilt_FiveCyclicDashboard extends BaseDashboard {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((FiveCyclicDashboard_GeneratedInjector) ((GeneratedComponentManagerHolder) UnsafeCasts.unsafeCast(this)).generatedComponent()).injectFiveCyclicDashboard((FiveCyclicDashboard) UnsafeCasts.unsafeCast(this));
    }
}
