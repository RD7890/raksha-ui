...
public abstract class Hilt_Dashboard extends BaseActivity implements GeneratedComponentManagerHolder {
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: com.dw.launcher.Hilt_Dashboard.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public void onContextAvailable(Context context) {
                Hilt_Dashboard.this.inject();
            }
        });
    }
    ...
    private void initSavedStateHandleHolder() {
        if (getApplication() instanceof GeneratedComponentManager) {
            SavedStateHandleHolder savedStateHandleHolder = m181componentManager().getSavedStateHandleHolder();
    ...
    public final ActivityComponentManager m181componentManager() {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((Dashboard_GeneratedInjector) generatedComponent()).injectDashboard((Dashboard) UnsafeCasts.unsafeCast(this));
    }
