...
public class HeartBarChart extends View {
    ...
    public HeartBarChart(Context context) {
        ...
        this.slideTextList = new ArrayList(Arrays.asList(80, 85, 90, 95, 100));
        ...
        this.isFinish = true;
        this.handler = new Handler(Looper.getMainLooper()) { // from class: com.dw.oxygen.HeartBarChart.1
    ...
    public void startAnimate2() {
        ...
        this.positionIndexList = new ArrayList(Collections.nCopies(24, 80));
        this.potLists = new ArrayList(Collections.nCopies(24, 80));
        this.currentBarIndex = 0;
